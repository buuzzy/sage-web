...
We also keep a complete local copy of your conversation data on your device (SQLite / IndexedDB) for fast offline reading.
...
同时，我们会在您的设备本地（SQLite / IndexedDB）保留一份完整的会话数据副本，用于快速离线读取。
